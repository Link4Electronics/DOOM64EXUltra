...
cp ../doom64ex-ultra.wad "${APPDIR}/usr/bin"
...
VERSION=$(grep "FileVersion" ../src/engine/doom64ex-ultra.rc | cut -d ' ' -f 3 | tr -d '"')
mv $BASENAME-$ARCH.AppImage doom64ex-ultra-$VERSION-linux-$ARCH.AppImage
